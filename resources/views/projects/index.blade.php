...
@section('content')
  ...
  <modal name="hello-world" classes="p-10 bg-card rounded-lg" height="auto">
    ...
    <div class="flex">
      <div class="flex-1 mr-4">
        <div class="mb-4">
          ...
          <input type="text"
                 id="title" name="title"
                 class="block border border-muted-light p-2 text-xs rounded w-full">
        </div>
        ...
        <div class="mb-4">
          ...
          <textarea type="text"
                    ...
                    class="block border border-muted-light p-2 text-xs rounded w-full" rows="5"></textarea>
        </div>
      </div>
    ...
    <footer class="flex justify-end">
      <button type="submit" class="button is-outline mr-4">Cancel</button>

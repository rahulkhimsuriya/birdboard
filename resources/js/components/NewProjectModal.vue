  ...
  <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
    ...
    <form @submit.prevent="submit">
        ...
        <div class="flex-1 mr-4">
          <div class="mb-4">
            ...
            <input type="text"
                   ...
                   v-model="form.title">
            <span class="text-xs text-error" v-if="errors.title" v-text="errors.title[0]"></span>
          </div>
          ...
          <div class="mb-4">
            ...
            <span class="text-xs text-error" v-if="errors.description" v-text="errors.description[0]"></span>
          </div>
        </div>
      ...
      <footer class="flex justify-end">
        <button type="submit" class="button is-outline mr-4" @click.prevent="$modal.hide('new-project')">Cancel</button>
